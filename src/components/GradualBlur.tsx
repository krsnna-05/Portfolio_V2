...
function GradualBlur(props) {
  ...
  return (
    <div
      ref={containerRef}
      className={`gradual-blur ${config.target === "page" ? "gradual-blur-page" : "gradual-blur-parent"} ${config.className} hidden md:block`}
...
const injectStyles = () => {
  ...
  .gradual-blur-inner { pointer-events: none; } hidden md:block z-50 relative`;
